...
export function OrigamiCraneLauncher({
  ...
  return (
    <>
      ...
      >
        <span className="grid size-[58px] place-items-center rounded-full border border-[#d7d0c3] bg-[radial-gradient(circle_at_50%_35%,#fffefb,#f0e7d8)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.8)]">
          <Image
            src="/images/landing/origami-crane-reference.png"
            alt=""
            width={80}
            height={80}
            className="size-[54px] animate-float object-contain transition-transform duration-500 group-hover:-rotate-3 group-hover:scale-105"
            priority={false}
          />
        </span>
